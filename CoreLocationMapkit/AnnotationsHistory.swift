...
class AnnotationsHistory {
    var annotations:[Annotations] = []
    init(){
        //Naples
        var annotation = Annotations( coordinate: CLLocationCoordinate2DMake(40.8367321,14.2468856), title: "Pizza Margherita", subtitle: "Street Food Nationalized")
        annotation.pizzaImage = #imageLiteral(resourceName: "Naples")
        ...
        //New York
        annotation = Annotations( coordinate: CLLocationCoordinate2DMake(40.7216294 , -73.995453), title: "New York Pizza", subtitle: "Pizza Comes to America")
        annotation.pizzaImage = #imageLiteral(resourceName: "New York")
        ...
        //Chicago
        annotation = Annotations( coordinate: CLLocationCoordinate2DMake(41.892479 , -87.6267592), title: "Chicago Deep Dish", subtitle: "No more flat crusts")
        annotation.pizzaImage = #imageLiteral(resourceName: "Chicago")
        ...
        //Chatham
        annotation = Annotations( coordinate: CLLocationCoordinate2DMake(42.4056555,-82.1860369), title: "Hawaiian/Canandian Pizza", subtitle: "Non-Italian Ingredients")
        annotation.pizzaImage = #imageLiteral(resourceName: "Chatham")
        ...
        //Beverly Hills
        annotation = Annotations( coordinate: CLLocationCoordinate2DMake(34.0674607,-118.3977309), title: "California Pizza", subtitle: "Is this a pizza?")
        annotation.pizzaImage = #imageLiteral(resourceName: "Beverly Hills")
